class Person
{
	public int myAge;			//年齢		パブリックで宣言
	private double myWeight;	//体重[kg]	プライベートで宣言
	private double myHeight;	//身長[cm]	プライベートで宣言
